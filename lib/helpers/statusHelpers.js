...
/**
 * Get color classes for urgency score (1-3)
 */
...
/**
 * Get color classes for RA 9003 category
 */
export function getRA9003Color(category) {
  switch (category) {
    case 'special':
      return 'bg-error/10 text-error border-error/30'
    case 'bulky':
...
/**
 * Format RA 9003 category for display
 */
export function formatRA9003Label(category) {
  switch (category) {
    case 'solid':
      return 'SOLID WASTE'
    case 'bulky':
