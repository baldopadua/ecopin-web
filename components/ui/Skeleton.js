...
export function SkeletonCard({ className = '' }) {
  return (
    <div className={`bg-surface-elevated border-2 border-border rounded-none shadow-[2px_2px_0px_0px_#1a1a1a] dark:shadow-[2px_2px_0px_0px_#333333] p-6 animate-pulse ${className}`}>
...
export function SkeletonStatCard({ className = '' }) {
  return (
    <div className={`bg-surface-elevated border-2 border-border rounded-none shadow-[2px_2px_0px_0px_#1a1a1a] dark:shadow-[2px_2px_0px_0px_#333333] p-6 border-l-8 animate-pulse ${className}`}>
